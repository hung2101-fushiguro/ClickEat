        ...
        <div class="flex h-full">
            ...
            <div class="p-4 md:p-8 max-w-7xl mx-auto">
                <c:if test="${not empty successMsg}">
                    <div class="mb-4 rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm font-semibold text-green-700">${successMsg}</div>
                </c:if>
                <c:if test="${not empty errorMsg}">
                    <div class="mb-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700">${errorMsg}</div>
                </c:if>
