    ...
    <main class="flex-grow">
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex justify-between items-end mb-4">
                ...
                <a href="#" class="text-sm text-orange-500 font-bold hover:text-orange-600">Xem tất cả</a>
            </div>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition group cursor-pointer overflow-hidden">
                    <div class="h-32 bg-gray-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=800" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    ...
                    <div class="p-4">
                        <h3 class="font-bold text-gray-900 line-clamp-1">Lollibee Q1 - Gà Rán</h3>
                        <p class="text-xs text-gray-500 mt-1 flex items-center gap-2">
                            <span><i class="fa-solid fa-motorcycle"></i> 15 phút</span>
                            <span>•</span>
                            <span>1.2 km</span>
                        </p>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition group cursor-pointer overflow-hidden">
                    <div class="h-32 bg-gray-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=800" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute top-2 right-2 bg-white px-2 py-1 rounded-md text-xs font-bold flex items-center gap-1 shadow-sm">
                            <i class="fa-solid fa-star text-yellow-400"></i> 4.5
                        </div>
                    </div>
                    <div class="p-4">
                        <h3 class="font-bold text-gray-900 line-clamp-1">Burger Station</h3>
                        <p class="text-xs text-gray-500 mt-1 flex items-center gap-2">
                            <span><i class="fa-solid fa-motorcycle"></i> 20 phút</span>
                            <span>•</span>
                            <span>2.5 km</span>
                        </p>
                    </div>
